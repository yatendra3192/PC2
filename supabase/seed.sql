-- ============================================================
-- PC2 v2.0 DEMO SEED DATA
-- Product: Orbit 24V 6-Zone Smart Irrigation Controller (B-0624W)
-- ============================================================

-- UUIDs for reference
-- Clients
--   siteone:  11111111-1111-1111-1111-111111111111
--   thd:      11111111-1111-1111-1111-222222222222
-- Users
--   admin:    22222222-2222-2222-2222-111111111111
--   reviewer: 22222222-2222-2222-2222-222222222222
--   viewer:   22222222-2222-2222-2222-333333333333
-- Taxonomy
--   dept:     33333333-3333-3333-3333-111111111111
--   cat:      33333333-3333-3333-3333-222222222222
--   class:    33333333-3333-3333-3333-333333333333
--   subclass: 33333333-3333-3333-3333-444444444444
-- Pipeline configs
--   siteone:  44444444-4444-4444-4444-111111111111
--   thd:      44444444-4444-4444-4444-222222222222
-- Templates
--   siteone:  55555555-5555-5555-5555-111111111111
--   thd:      55555555-5555-5555-5555-222222222222
-- Supplier template
--   orbit:    66666666-6666-6666-6666-111111111111
...
INSERT INTO users (id, email, password_hash, full_name, role, client_id) VALUES
  ('22222222-2222-2222-2222-111111111111', 'admin@iksula.com',
   '$2b$12$LJ3m4ys4I3OxKBGqGMu.8eQrYzE7m5l3v5u8V6kF9W7wDmO7x3Mq6',
   'Abhishek K.', 'admin', NULL),
...
-- ============================================================
-- TAXONOMY: Hardware & Tools > Irrigation > Controllers > Smart Controllers
-- ============================================================
...
-- ============================================================
-- IKSULA CLASS ATTRIBUTES for Smart Controllers (17 attributes)
-- ============================================================
...
INSERT INTO supplier_templates (id, supplier_name, supplier_code, format_type, template_name, field_definitions) VALUES
  ('66666666-6666-6666-6666-111111111111', 'Orbit Irrigation Products', 'orbit', 'csv', 'Orbit CSV Catalog 2026',
   '[
     {"supplier_field": "Product Name", "data_type": "text"},
     {"supplier_field": "Model", "data_type": "text"},
     {"supplier_field": "Voltage", "data_type": "text"},
     {"supplier_field": "# Stations", "data_type": "text"},
     {"supplier_field": "WiFi", "data_type": "text"},
     {"supplier_field": "IP", "data_type": "text"},
     {"supplier_field": "Wt", "data_type": "text"},
     {"supplier_field": "Clr", "data_type": "text"},
     {"supplier_field": "Op Temp", "data_type": "text"},
     {"supplier_field": "Warranty (mo)", "data_type": "text"}
   ]');

-- Supplier field mappings (Orbit → Iksula)
INSERT INTO supplier_field_mappings (supplier_template_id, taxonomy_node_id, supplier_field_name, supplier_field_alias, iksula_attribute_id, normalise_rule, mapping_status) VALUES
  ...
  ('66666666-6666-6666-6666-111111111111', '33333333-3333-3333-3333-444444444444', '# Stations', '{"Stations","Zones","Zone Count"}', 'aa000001-0000-0000-0000-000000000002', '{"type":"regex_extract","pattern":"(\\d+)"}', 'auto'),
  ('66666666-6666-6666-6666-111111111111', '33333333-3333-3333-3333-444444444444', 'WiFi', '{"Wi-Fi","Wireless"}', 'aa000001-0000-0000-0000-000000000003', '{"type":"boolean_parse","true_values":["Yes","Y","1","TRUE"]}', 'auto'),
  ('66666666-6666-6666-6666-111111111111', '33333333-3333-3333-3333-444444444444', 'IP', '{"IP Rating","IPRating"}', 'aa000001-0000-0000-0000-000000000004', '{"type":"direct"}', 'auto'),
  ('66666666-6666-6666-6666-111111111111', '33333333-3333-3333-3333-444444444444', 'Wt', '{"Weight","Wt.","Wght"}', 'aa000001-0000-0000-0000-000000000007', '{"type":"unit_convert","from":"lbs","to":"kg","factor":0.453592}', 'auto'),
  ('66666666-6666-6666-6666-111111111111', '33333333-3333-3333-3333-444444444444', 'Clr', '{"Color","Colour"}', 'aa000001-0000-0000-0000-000000000005', '{"type":"value_map","map":{"GRY":"grey","WHT":"white","BLK":"black","GRN":"green"}}', 'corrected'),
...
-- ============================================================
-- CLIENT FIELD MAPPINGS: SiteOne (Iksula → SiteOne Template v2.4)
-- ============================================================
INSERT INTO client_field_mappings (client_id, template_id, taxonomy_node_id, iksula_attribute_id, client_field_name, client_field_code, client_field_order, is_mandatory, transform_rule, mapping_status) VALUES
  ...
  ('11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-111111111111', '33333333-3333-3333-3333-444444444444', 'aa000001-0000-0000-0000-000000000003', 'Wi-Fi Enabled', 'wifi', 3, true, '{"type":"boolean_format","true":"Yes","false":"No"}', 'auto'),
  ...
  ('11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-111111111111', '33333333-3333-3333-3333-444444444444', 'aa000001-0000-0000-0000-000000000005', 'Product Color', 'color', 5, true, '{"type":"lookup"}', 'auto'),
  ('11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-111111111111', '33333333-3333-3333-3333-444444444444', 'aa000001-0000-0000-0000-000000000006', 'Material', 'material', 6, true, '{"type":"lookup"}', 'auto'),
  ('11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-111111111111', '33333333-3333-3333-3333-444444444444', 'aa000001-0000-0000-0000-000000000007', 'Weight (lbs)', 'weight_lbs', 7, true, '{"type":"unit_convert","from":"kg","to":"lbs","factor":2.20462}', 'auto'),
  ('11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-111111111111', '33333333-3333-3333-3333-444444444444', 'aa000001-0000-0000-0000-000000000008', 'Shipping Weight (lbs)', 'ship_weight_lbs', 8, true, '{"type":"unit_convert","from":"kg","to":"lbs","factor":2.20462}', 'auto'),
  ('11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-111111111111', '33333333-3333-3333-3333-444444444444', 'aa000001-0000-0000-0000-000000000014', 'Certifications', 'certifications', 9, true, '{"type":"join","separator":", ","use_labels":true}', 'auto'),
  ('11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-111111111111', '33333333-3333-3333-3333-444444444444', 'aa000001-0000-0000-0000-000000000017', 'Warranty Period', 'warranty', 10, false, '{"type":"duration_format","output":"years"}', 'auto'),
...
-- CLIENT VALUE MAPPINGS: SiteOne colour values
INSERT INTO client_value_mappings (client_field_mapping_id, iksula_value_code, iksula_value_label, client_value, mapping_status)
SELECT cfm.id, 'grey', 'Grey', 'Gray', 'corrected'
FROM client_field_mappings cfm WHERE cfm.client_field_code = 'color' AND cfm.template_id = '55555555-5555-5555-5555-111111111111';

INSERT INTO client_value_mappings (client_field_mapping_id, iksula_value_code, iksula_value_label, client_value, mapping_status)
SELECT cfm.id, 'white', 'White', 'White', 'auto'
FROM client_field_mappings cfm WHERE cfm.client_field_code = 'color' AND cfm.template_id = '55555555-5555-5555-5555-111111111111';

INSERT INTO client_value_mappings (client_field_mapping_id, iksula_value_code, iksula_value_label, client_value, mapping_status)
SELECT cfm.id, 'black', 'Black', 'Black', 'auto'
FROM client_field_mappings cfm WHERE cfm.client_field_code = 'color' AND cfm.template_id = '55555555-5555-5555-5555-111111111111';

-- Material value mappings
INSERT INTO client_value_mappings (client_field_mapping_id, iksula_value_code, iksula_value_label, client_value, mapping_status)
SELECT cfm.id, 'abs_plastic', 'ABS Plastic', 'ABS Plastic', 'auto'
FROM client_field_mappings cfm WHERE cfm.client_field_code = 'material' AND cfm.template_id = '55555555-5555-5555-5555-111111111111';
...
INSERT INTO prompt_templates (template_name, model_type, taxonomy_node_id, client_id, template_text, version) VALUES
  ('Iksula Copy Prompt — Irrigation Controllers v3.0 — SiteOne edition', 'llm',
   ...
   'You are a product content writer for SiteOne Landscape Supply. Generate professional B2B product copy for contractors and landscape professionals.

Product: {{product_name}}
Model: {{model_number}}
Key Specs: {{specs_summary}}

Generate:
1. Product Title (max 80 chars, SEO-optimised, include key specs)
2. Short Description (max 150 chars, feature-led for contractor audience)
3. Long Description (max 400 chars, spec-heavy, B2B professional tone)

Focus on: durability, ease of installation, compatibility, professional features.',
   '3.0');

-- ============================================================
-- EXISTING PRODUCT: Orbit 4-Zone Controller (for dedup matching)
-- ============================================================
...
-- Existing product's Iksula values (for dedup comparison)
...
-- Set boolean value for wifi separately (value_boolean column)
